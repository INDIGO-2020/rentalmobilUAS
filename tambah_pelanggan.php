...
'login.php'</script>";
    ...
    <head>
        ...
        <title>UAS PI : Tambah Pelanggan</title>
    ...
    <body>
        ...
        <div class="header">
            <div class="pull-left">
                <div class="logo"><a href="tambah_pelanggan.php"><img src="assets/images/(AM) Mana Void Build.png" width="10%" alt="" />
                            ...
                            <div class="page-header">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        <li><a href="tambah_pelanggan.php">Dashboard</a></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="basic-form">
                                            <form method="POST" action="fungsi_tambah_pelanggan.php">
                                                <div class="form-group">
                                                    <label for="nik_ktp_anggaaf" class="form-label">NIK</label>
                                                    <input type="number" name="nik_ktp_anggaaf" class="form-control"
                                                        id="nik_ktp_anggaaf" placeholder="Masukan No NIK KTP" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_anggaaf" class="form-label">Nama</label>
                                                    <input type="text" name="nama_anggaaf" class="form-control"
                                                        id="nama_anggaaf" placeholder="Masukan Nama Pelanggan" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="no_hp_anggaaf" class="form-label">No HP</label>
                                                    <input type="number" name="no_hp_anggaaf" class="form-control"
                                                        id="no_hp_anggaaf" placeholder="Masukan No HP" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="alamat_anggaaf" class="form-label">Alamat</label>
                                                    <textarea name="alamat_anggaaf" class="form-control" id="alamat_anggaaf"
