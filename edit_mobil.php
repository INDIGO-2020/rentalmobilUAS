...
'login.php'</script>";
    ...
    <body>
        ...
        <div class="header">
            <div class="pull-left">
                <div class="logo"><a href="index.html"><img src="assets/images/(AM) Mana Void Build.png" width="10%" alt="" /><span>RENTAL MOBIL AAF</span></a></div>
                                    ...
                                    <div class="card-body">
                                        <div class="basic-form">
                                            <form method="POST" action="fungsi_edit_mobil.php">
                                                ...
                                                $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_mobil_anggaaf WHERE no_plat_anggaaf='$no_plat_anggaaf'");
                                                $data = mysqli_fetch_array($tampil);
                                                ?>
                                                <div class="form-group">
                                                    <label for="no_plat_anggaaf" class="form-label">Plat Nomor</label>
                                                    <input type="hidden" name="no_plat_tmp_anggaaf"
                                                        value="<?= $data['no_plat_anggaaf'] ?>" class="form-control"
                                                        id="no_plat_tmp_anggaaf">
                                                    <input type="text" name="no_plat_anggaaf"
                                                        value="<?= $data['no_plat_anggaaf'] ?>" class="form-control"
                                                        id="no_plat_anggaaf" placeholder="Masukan No Plat">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_mobil_anggaaf" class="form-label">Nama Mobil</label>
                                                    <input type="text" name="nama_mobil_anggaaf"
                                                        value="<?= $data['nama_mobil_anggaaf'] ?>" class="form-control"
                                                        id="nama_mobil_anggaaf" placeholder="Masukan Nama Mobil" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="brand_mobil_anggaaf" class="form-label">Brand Mobil
                                                        :</label>
                                                    <input type="text" name="brand_mobil_anggaaf"
                                                        value="<?= $data['brand_mobil_anggaaf'] ?>" class="form-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select for="tipe_transmisi_anggaaf" name="tipe_transmisi_anggaaf"
                                                        class="form-control" id="tipe_transmisi_anggaaf">
                                                        <option value="<?= $data['tipe_transmisi_anggaaf'] ?>">
                                                            <?= $data['tipe_transmisi_anggaaf'] ?>
                                                        </option>
