...
<title>UAS PI : Tampil Mobil</title>
...
<div class="header">
<div class="pull-left">
<div class="logo"><a href="tampil_mobil.php">
...
<a href="tambah_mobil.php" type="button" class="btn btn-rounded btn-success">Tambah Data</a>
<div class="card-body">
        ...
        <tbody>
            ...
            while ($data = mysqli_fetch_array($tampil)) {
                ...
                <tr>
                    ...
                    <td>
                        <?= $data['no_plat_anggaaf'] ?>
                    </td>
                    <td>
                        <?= $data['nama_mobil_anggaaf'] ?>
                    </td>
                    <td>
                        <?= $data['brand_mobil_anggaaf'] ?>
                    </td>
                    <td>
                        <?= $data['tipe_transmisi_anggaaf'] ?>
                    </td>
                    <td>
                        <a href="edit_mobil.php?no_plat_anggaaf=<?= $data['no_plat_anggaaf'] ?>"
                            class='btn btn-rounded btn-primary'>Edit</a>
                        <a href="delete_mobil.php?no_plat_anggaaf=<?= $data['no_plat_anggaaf'] ?>"
